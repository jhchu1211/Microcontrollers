...
{    
    ...
    switch(Nec_state)
    {
        ...
        case 4 :                            
        {
            if (Time_Elapsed > 400 && Time_Elapsed < 1800)                      // Check if Time_Elapsed read is between 400 usec and 1800 usec
            { 
                Nec_code = Nec_code << 1;                                       // shift left nec_code by one bit
                if (Time_Elapsed > 1000)                                        // check if Time_Elapsed is greater than 1000 usec
                {
                    Nec_code = Nec_code + 1;                                    // add 1 to Nec_Code
                }
                ...
                if (bit_count > 31)                                             // Check if bit_count > 31
                {
                    ...
                    INTCONbits.INT0IE = 0;                                      // Set INT0IE = 0
