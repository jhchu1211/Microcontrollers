...
SOURCEFILES_QUOTED_IF_SPACED=Interrupt.c I2C_Support.c I2C.c Fan_Support.c ST7735_TFT.c Main_Screen.c Utils.c LabFinal.c Setup_Time.c Setup_Heater.c Setup_Alarm.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Interrupt.p1 ${OBJECTDIR}/I2C_Support.p1 ${OBJECTDIR}/I2C.p1 ${OBJECTDIR}/Fan_Support.p1 ${OBJECTDIR}/ST7735_TFT.p1 ${OBJECTDIR}/Main_Screen.p1 ${OBJECTDIR}/Utils.p1 ${OBJECTDIR}/LabFinal.p1 ${OBJECTDIR}/Setup_Time.p1 ${OBJECTDIR}/Setup_Heater.p1 ${OBJECTDIR}/Setup_Alarm.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/Interrupt.p1.d ${OBJECTDIR}/I2C_Support.p1.d ${OBJECTDIR}/I2C.p1.d ${OBJECTDIR}/Fan_Support.p1.d ${OBJECTDIR}/ST7735_TFT.p1.d ${OBJECTDIR}/Main_Screen.p1.d ${OBJECTDIR}/Utils.p1.d ${OBJECTDIR}/LabFinal.p1.d ${OBJECTDIR}/Setup_Time.p1.d ${OBJECTDIR}/Setup_Heater.p1.d ${OBJECTDIR}/Setup_Alarm.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Interrupt.p1 ${OBJECTDIR}/I2C_Support.p1 ${OBJECTDIR}/I2C.p1 ${OBJECTDIR}/Fan_Support.p1 ${OBJECTDIR}/ST7735_TFT.p1 ${OBJECTDIR}/Main_Screen.p1 ${OBJECTDIR}/Utils.p1 ${OBJECTDIR}/LabFinal.p1 ${OBJECTDIR}/Setup_Time.p1 ${OBJECTDIR}/Setup_Heater.p1 ${OBJECTDIR}/Setup_Alarm.p1

# Source Files
SOURCEFILES=Interrupt.c I2C_Support.c I2C.c Fan_Support.c ST7735_TFT.c Main_Screen.c Utils.c LabFinal.c Setup_Time.c Setup_Heater.c Setup_Alarm.c
...
${OBJECTDIR}/LabFinal.p1: LabFinal.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1  --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/LabFinal.p1 LabFinal.c 
...
${OBJECTDIR}/Setup_Heater.p1: Setup_Heater.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Setup_Heater.p1.d 
	@${RM} ${OBJECTDIR}/Setup_Heater.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1  --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/Setup_Heater.p1 Setup_Heater.c 
	@-${MV} ${OBJECTDIR}/Setup_Heater.d ${OBJECTDIR}/Setup_Heater.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/Setup_Heater.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
	
${OBJECTDIR}/Setup_Alarm.p1: Setup_Alarm.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Setup_Alarm.p1.d 
	@${RM} ${OBJECTDIR}/Setup_Alarm.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1  --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/Setup_Alarm.p1 Setup_Alarm.c 
	@-${MV} ${OBJECTDIR}/Setup_Alarm.d ${OBJECTDIR}/Setup_Alarm.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/Setup_Alarm.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
