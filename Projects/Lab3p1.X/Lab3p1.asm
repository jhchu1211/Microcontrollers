...
START:
 MOVLW 0x0F ; Load W with 0x0F0 -> ADCON1 = 0x0F;
 MOVWF ADCON1 ; Make ADCON1 to be all digital
 MOVLW 0x00 ; Load W with 0x00 -> TRISB = 0x00;
 MOVWF TRISB ; Make PORT B as outputs
MAIN_LOOP:
 MOVLW 0x05 ; Load W with value 0x05 -> PORTB = 0x05;
 MOVWF PORTB ; Output to PORT B
;
 CALL DELAY_ONE_SEC ; delay one second
 MOVLW 0x0A ; Load W with value 0x0A -> PORTB = 0x0A;
